...
namespace GuardianshipFinancialReporting.Controllers
{
    ...
    public class UserCategoriesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(userCategories.ToList().OrderBy(u => u.CategoryType).ThenBy(u => u.Ordinal));
        ...
        public ActionResult Create([Bind(Include = "CategoryID,UserID,CategoryType,CategoryClass,CategoryName,Ordinal")] UserCategory userCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,UserID,CategoryType,CategoryClass,CategoryName,Ordinal")] UserCategory userCategory)
        {
            if (ModelState.IsValid)
            {
